document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('touchend', updateBackToTopVisibility, { passive: true });
  ...
  // Clé gratuite à créer sur https://web3forms.com avec votre e-mail
  ...
  if (form) {
    ...
    form.addEventListener('submit', function (event) {
      ...
      if (nom.value.trim() === '') {
        ...
        setFieldError(nom, errorNom, 'Le nom doit contenir au moins 2 caractères.');
        firstInvalidField = nom;
        isValid = false;
      }
      ...
      if (message.value.trim() === '') {
        ...
        setFieldError(message, errorMessage, 'Le message doit contenir au moins 10 caractères.');
        firstInvalidField = firstInvalidField || message;
        isValid = false;
      }
        ...
        fetch('https://api.web3forms.com/submit', {
          ...
          .then(function (data) {
            if (data.success) {
              ...
              successMsg.textContent =
                'Envoi impossible pour le moment. Écrivez à ' + CONTACT_EMAIL + '.';
            }
          })
          .catch(function () {
            successMsg.textContent =
